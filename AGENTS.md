...
4. `project-standards/` 中的项目级规则优先于 `code-standards/` 中的通用规则。
...
- 涉及函数、组件、hooks、模块导出或公共能力设计时，阅读[API 设计规范](./code-standards/api-design.md)。
- 涉及 README、API 文档、示例、迁移说明时，阅读[文档规范](./code-standards/documentation.md)。
